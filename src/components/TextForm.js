...
function TextForm(props) {
  ...
  return (
    <>
      <div
        className={`mt-20 lg:mt-14 flex flex-col items-center justify-center gap-8 text-${props.textColor}`}
      >
        <div
        ...
        >
          <div className=" w-full lg:w-1/2 p-4 lg:border-r-2">
            ...
            <textarea
              name="text"
              id="myBox"
              className={`border border-black rounded-2xl w-full h-[170px] lg:h-1/2 pt-2 px-2 scrollbar-hide text-black`}
              value={text}
